                        ...
                        <ClassList>
                            {classes.map(item => (
                                <Class
                                    key={item.id}
                                    onClick={() =>
                                        handleShowClassDetails(item.id)
                                    }
                                >
                                    <p>
                                        Class Code:{' '}
                                    ...
                                    <p>
                                        Class Day:{' '}
                                        <strong>{item.class_day}</strong>
                                    </p>
                                    <p>
                                        Class Hour:{' '}
                                        <strong>{item.class_hour} h</strong>
                                    </p>
                                    <p>
                                        Class Teacher:{' '}
                                        <strong>
                                    ...
                                    {dateInFocus ? (
                                        ...
                                        retrievedTimetable.map(timetable => (
                                            ...
                                            >
                                                ...
                                                <p>
                                                    Class no:{' '}
                                                    {timetable.class_number}
                                                </p>
                                                <p>
                                                    Class Status:{' '}
                                                    {timetable.class_status}
                                                </p>
                                            </Timetable>
                                        ))
                                    )}
